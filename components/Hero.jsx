...
export default function Hero() {
	return (
		<section className="flex h-[calc(100dvh-var(--header-height))] flex-col bg-primary pt-10">
			...
			<button className="mb-2 mt-4 flex items-center justify-center gap-1 self-center rounded-10 border-2 border-accent px-4 py-2 font-bold text-white">
			...
			<Image
				...
				width={2856}
				height={1658}
				className="h-full w-auto object-cover [mask-image:linear-gradient(transparent,rgba(0,0,0,1)_30%)]"
			/>
		</section>
	)
}
