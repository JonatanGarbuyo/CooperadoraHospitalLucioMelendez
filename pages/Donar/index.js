      ...
      <div className={styles.donar_container}>
        ...
        <section id="botones_donaciones" className={styles.botones_donaciones}>
          ...
          <div id="botones_donaciones_wrapper" className={styles.botones_donaciones_wrapper}>
            <a href="https://mpago.la/2eRw8YF" target="_blank" style={{"backgroundColor":"#4d95be"}}>
              Donación por única vez
              <p>$500</p>
              quinientos pesos
            </a>  
            <a  href="https://mpago.la/2BFVwq7" target="_blank" style={{"backgroundColor":"#0067a2"}}>
              Donación por única vez
              <p>$1000</p>
              mil pesos
            </a>  
            <a  href="https://mpago.la/1sDpGAy" target="_blank" style={{"backgroundColor":"#15b4b5"}}>
              Donación por única vez
              <p>$3000</p>
              tres mil pesos
            </a>  
            <a  href="https://mpago.la/11TABB1" target="_blank" style={{"backgroundColor":"#159b97"}}>
              Donación por única vez
              <p>$5000</p>
              cinco mil pesos
            </a>
