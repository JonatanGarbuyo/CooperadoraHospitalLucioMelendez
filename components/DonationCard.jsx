...
export default function DonationCard() {
	return (
		<div className="z-40 mb-2 flex max-h-[294px] min-h-[294px] min-w-[420px] max-w-[420px] items-center self-center rounded-10 bg-white text-center shadow-md max-md:hidden lg:absolute lg:right-10 lg:top-[calc(2.5rem+var(--header-height))] lg:mb-0">
			<div>
