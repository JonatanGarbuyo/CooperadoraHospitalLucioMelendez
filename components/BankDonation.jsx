...
export default function BankDonation() {
	return (
		<section className="flex flex-col items-center gap-6 px-4 py-10 text-center md:gap-8 md:px-10 md:py-16 xl:py-24 xl:text-left">
			...
			<div className="relative rounded-10 px-2 py-4 shadow-[0px_1px_4px_1px_rgba(0,0,0,0.1)] md:px-4 md:py-7 xl:grid xl:grid-cols-2 xl:gap-8">
				...
				<div>
					<p className="mb-4 text-pretty text-xl font-medium text-black md:mb-5 md:mt-6 md:text-3xl xl:mt-0">
